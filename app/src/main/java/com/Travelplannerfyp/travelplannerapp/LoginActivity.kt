...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.w("ADMIN_BTN", "WARNING: This is a warning test")
        Log.i("ADMIN_BTN", "INFO: This is an info test")
        System.out.println("ADMIN_BTN: System.out test - LoginActivity onCreate")
