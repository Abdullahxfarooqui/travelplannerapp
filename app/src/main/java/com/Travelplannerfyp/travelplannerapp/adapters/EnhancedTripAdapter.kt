...
class EnhancedTripAdapter(
    ...
    inner class TripViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun displayHotelInfo(hotel: Hotel?) {
            Log.d("HotelCardDebug", "displayHotelInfo called with: $hotel")
            ...
            if (hotel != null && (hotel.name.isNotEmpty() || hotel.pricePerNight.isNotEmpty())) {
                ...
                HotelImageLoader.loadHotelImage(hotel.imageUrl, hotel.imageName, hotel.name, hotelImageView)
            } else {
            ...
            Log.d("HotelCardDebug", "hotelCardView.visibility: ${hotelCardView.visibility}")
        }
        ...
        private fun formatPrice(price: String): String {
            ...
            return if (priceDouble > 0.0) {
                CurrencyUtils.formatAsPKR(priceDouble)
            } else {
                "Price not set"
            }
        }
