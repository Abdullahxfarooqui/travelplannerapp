    ...
    private fun loadProfileImage() {
        ...
        if (user != null) {
            ...
            if (!cachedImageUrl.isNullOrEmpty()) {
                ...
                com.example.travelplannerapp.utils.ProfileImageManager.loadProfileImage(profileImage, cachedImageUrl)
            ...
            userRef.get().addOnSuccessListener { snapshot ->
                ...
                if (!imageUrl.isNullOrEmpty() && imageUrl != cachedImageUrl) {
                    com.example.travelplannerapp.utils.ProfileImageManager.loadProfileImage(profileImage, imageUrl)
                    ...
                    com.example.travelplannerapp.utils.ProfileImageManager.saveProfileImageToDatabase(
                        ...
                        onSuccess = { dbUrl ->
                            try {
                                ...
                                // Load the image
                                com.example.travelplannerapp.utils.ProfileImageManager.loadProfileImage(profileImage, dbUrl)
